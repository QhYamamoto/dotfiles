...
(( $+functions[_my-cli-tool__ahk_commands] )) ||
_my-cli-tool__ahk_commands() {
    local commands; commands=()
    _describe -t commands 'my-cli-tool ahk commands' commands "$@"
}
...
(( $+functions[_my-cli-tool__help__ahk_commands] )) ||
_my-cli-tool__help__ahk_commands() {
    local commands; commands=()
    _describe -t commands 'my-cli-tool help ahk commands' commands "$@"
}
